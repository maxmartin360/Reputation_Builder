...
var showUser = function(user) {
	...
	var userElem = result.find('.profile a');
	userElem.attr('href', user.link);


	var userLink = result.find('.profile img');
	userLink.attr('src', user.profile_image);
...
// this function takes the tag object returned from stack overflow 
